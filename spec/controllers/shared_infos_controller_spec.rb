...
RSpec.describe SharedInfosController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested shared_info as @shared_info" do
      shared_info = SharedInfo.create! valid_attributes
      get :show, {:id => shared_info.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested shared_info as @shared_info" do
      shared_info = SharedInfo.create! valid_attributes
      get :edit, {:id => shared_info.to_param}, valid_session
      expect(assigns(:shared_info)).to eq(shared_info)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new SharedInfo" do
        expect {
          post :create, {:shared_info => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shared_info as @shared_info" do
        post :create, {:shared_info => invalid_attributes}, valid_session
        expect(assigns(:shared_info)).to be_a_new(SharedInfo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested shared_info" do
        shared_info = SharedInfo.create! valid_attributes
        put :update, {:id => shared_info.to_param, :shared_info => new_attributes}, valid_session
        shared_info.reload
      ...
      it "assigns the requested shared_info as @shared_info" do
        shared_info = SharedInfo.create! valid_attributes
        put :update, {:id => shared_info.to_param, :shared_info => valid_attributes}, valid_session
        expect(assigns(:shared_info)).to eq(shared_info)
      end
    ...
    describe "with invalid params" do
      it "assigns the shared_info as @shared_info" do
        shared_info = SharedInfo.create! valid_attributes
        put :update, {:id => shared_info.to_param, :shared_info => invalid_attributes}, valid_session
        expect(assigns(:shared_info)).to eq(shared_info)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested shared_info" do
      shared_info = SharedInfo.create! valid_attributes
      expect {
        delete :destroy, {:id => shared_info.to_param}, valid_session
      }.to change(SharedInfo, :count).by(-1)
    end
