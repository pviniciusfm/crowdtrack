...
RSpec.describe CheckpointsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all checkpoints as @checkpoints" do
      ...
      expect(assigns(:checkpoints)).to eq([checkpoint])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested checkpoint as @checkpoint" do
      ...
      expect(assigns(:checkpoint)).to eq(checkpoint)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created checkpoint as @checkpoint" do
        post :create, {:checkpoint => valid_attributes}, valid_session
        expect(assigns(:checkpoint)).to be_a(Checkpoint)
        expect(assigns(:checkpoint)).to be_persisted
      end

      it "redirects to the created checkpoint" do
        post :create, {:checkpoint => valid_attributes}, valid_session
        expect(response).to redirect_to(Checkpoint.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved checkpoint as @checkpoint" do
        post :create, {:checkpoint => invalid_attributes}, valid_session
        expect(assigns(:checkpoint)).to be_a_new(Checkpoint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested checkpoint" do
        checkpoint = Checkpoint.create! valid_attributes
        put :update, {:id => checkpoint.to_param, :checkpoint => new_attributes}, valid_session
        checkpoint.reload
      ...
      it "redirects to the checkpoint" do
        checkpoint = Checkpoint.create! valid_attributes
        put :update, {:id => checkpoint.to_param, :checkpoint => valid_attributes}, valid_session
        expect(response).to redirect_to(checkpoint)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the checkpoint as @checkpoint" do
        checkpoint = Checkpoint.create! valid_attributes
        put :update, {:id => checkpoint.to_param, :checkpoint => invalid_attributes}, valid_session
        expect(assigns(:checkpoint)).to eq(checkpoint)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the checkpoints list" do
      checkpoint = Checkpoint.create! valid_attributes
      delete :destroy, {:id => checkpoint.to_param}, valid_session
      expect(response).to redirect_to(checkpoints_url)
    end
  end
